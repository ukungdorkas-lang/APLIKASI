                      ...
                      {weatherUpstream.map((weather) => (
                        ...
                        >
                          ...
                          <div className="flex justify-between items-start mb-8">
                            <div>
                              <h5 className="text-xl font-black italic uppercase tracking-tighter text-white mb-1">
                                {weather.location}
                              </h5>
                              <div className="inline-block bg-brand-red/20 text-brand-red text-[8px] font-black uppercase px-3 py-1 rounded-full tracking-widest border border-brand-red/30 italic">
                            ...
                            <div className="flex gap-2">
                              ...
                              <button
                                className="p-2 bg-white/5 text-slate-400 rounded-lg hover:text-brand-red transition-colors"
                                onClick={() =>
                                  handleDeleteItem(
                                    "weather_upstream",
                                    weather.id,
                          ...
                          <div className="grid grid-cols-2 gap-6 mb-8">
                            ...
                            <div className="space-y-1">
                              ...
                              <p className="text-2xl font-black uppercase italic tracking-tighter text-brand-red">
                                {weather.rainfall} mm
                              </p>
                            </div>
                          </div>
                            ...
                            <div className="flex justify-between items-center">
                              ...
                              <span
                                className={cn(
                                  ...
                                  weather.overflowPotential === "Rendah"
                                    ? "bg-green-500/20 text-green-400"
                                    : weather.overflowPotential === "Sedang"
