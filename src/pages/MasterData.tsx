...
import { collection, onSnapshot, query, addDoc, updateDoc, deleteDoc, doc, orderBy, getDocs } from 'firebase/firestore';
                      ...
                      <tr key={`personnel-${p.id}-${idx}`} className="hover:bg-slate-50 transition-colors">
                        <td className="p-8">
                          <div className="flex items-center gap-4">
                             <div className="w-10 h-10 rounded-full bg-slate-100 flex items-center justify-center font-black text-brand-red italic">{p.name[0]}</div>
                             <div>
                                <p className="font-black italic uppercase tracking-tighter text-slate-900">{p.name}</p>
